...
export const SYMPTOMS_BY_CANCER = {
  LLA: [
    { code: "LLA-S01", label: "Palidez persistente (> 2 semanas)",                              level: 2 },
    { code: "LLA-S02", label: "Fiebre prolongada sin foco infeccioso (> 7 días)",               level: 2 },
    { code: "LLA-S03", label: "Petequias o equimosis sin traumatismo",                          level: 3 },
    { code: "LLA-S04", label: "Dolor óseo o articular difuso persistente",                      level: 3 },
    { code: "LLA-S05", label: "Adenopatías múltiples (> 1 región, > 2 cm)",                    level: 3 },
    { code: "LLA-S06", label: "Fatiga extrema / letargia desproporcionada",                     level: 2 },
    { code: "LLA-S07", label: "Hepatoesplenomegalia palpable",                                  level: 3 },
    { code: "LLA-S08", label: "Tríada cardinal: palidez, fiebre y petequias simultáneas",      level: 4 },
  ],
  BKT: [
    { code: "BKT-S01", label: "Masa abdominal de crecimiento rápido (días a semanas)",          level: 4 },
    { code: "BKT-S02", label: "Adenopatías cervicales o mandibulares de crecimiento rápido",    level: 3 },
    { code: "BKT-S03", label: "Fiebre + pérdida de peso (síntomas B)",                         level: 2 },
    { code: "BKT-S04", label: "Distensión abdominal progresiva + dolor abdominal difuso",       level: 3 },
    { code: "BKT-S05", label: "Masa maxilofacial o tumefacción facial asimétrica",              level: 4 },
  ],
  LH: [
    { code: "LH-S01", label: "Adenopatías cervicales o supraclaviculares indoloras (> 2 cm, > 4 sem)", level: 3 },
    { code: "LH-S02", label: "Fiebre Pel-Ebstein (cíclica, ondulante)",                        level: 3 },
    { code: "LH-S03", label: "Sudoración nocturna profusa (empapa la ropa)",                   level: 2 },
    { code: "LH-S04", label: "Pérdida de peso involuntaria > 10% en 6 meses",                  level: 2 },
    { code: "LH-S05", label: "Masa mediastínica / disnea progresiva sin causa infecciosa",     level: 4 },
    { code: "LH-S06", label: "Prurito generalizado sin causa dermatológica",                    level: 2 },
    { code: "LH-S07", label: "Tríada B completa con adenopatía supraclavicular indolora",       level: 4 },
  ],
  TW: [
    { code: "TW-S01", label: "Masa abdominal unilateral palpable, firme, no dolorosa",         level: 4 },
    { code: "TW-S02", label: "Hematuria macroscópica (orina rosada o roja)",                   level: 3 },
    { code: "TW-S03", label: "Hipertensión arterial sin causa evidente en menor de 5 años",    level: 3 },
    { code: "TW-S04", label: "Dolor abdominal localizado en flanco",                           level: 2 },
    { code: "TW-S05", label: "Aniridia / hemihipertrofia / anomalías genitourinarias congénitas", level: 4 },
  ],
  RB: [
    { code: "RB-S01", label: "Leucocoria (reflejo pupilar blanco / ojo de gato)",              level: 4 },
    { code: "RB-S02", label: "Estrabismo de nuevo inicio (sin antecedente previo)",            level: 3 },
    { code: "RB-S03", label: "Ojo rojo persistente sin causa infecciosa documentada",          level: 2 },
    { code: "RB-S04", label: "Pérdida visible de visión / nistagmo",                           level: 3 },
    { code: "RB-S05", label: "Historia familiar de retinoblastoma (padre o hermano)",          level: 4 },
  ],
  GBG: [
    { code: "GBG-S01", label: "Cefalea persistente > 4 semanas (especialmente matutina)",      level: 2 },
    { code: "GBG-S02", label: "Vómitos matutinos en proyectil sin causa gastrointestinal",     level: 3 },
    { code: "GBG-S03", label: "Alteraciones visuales progresivas (visión doble, pérdida de campo)", level: 3 },
    { code: "GBG-S04", label: "Cambios en la marcha / ataxia / torpeza motora progresiva",    level: 3 },
    { code: "GBG-S05", label: "Convulsiones de novo (sin antecedente de epilepsia)",          level: 3 },
    { code: "GBG-S06", label: "Cambios conductuales o de personalidad progresivos inexplicables", level: 2 },
    { code: "GBG-S07", label: "Tríada HTIC: cefalea matutina, vómitos y alt. visual o marcha", level: 4 },
  ],
};
